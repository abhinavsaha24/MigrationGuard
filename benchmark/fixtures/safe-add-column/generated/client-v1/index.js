...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\abhin\\Videos\\MigrationGuard\\benchmark\\fixtures\\safe-add-column\\generated\\client-v1",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\abhin\\Videos\\MigrationGuard\\benchmark\\fixtures\\safe-add-column\\schema-v1.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  ...
  "inlineSchemaHash": "ada892baa6357f91be26ee34c9f6e5163d61fbded67f438a807dd86aad5623d7",
  "copyEngine": true
}
...
path.join(process.cwd(), "generated/client-v1/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "generated/client-v1/schema.prisma")
