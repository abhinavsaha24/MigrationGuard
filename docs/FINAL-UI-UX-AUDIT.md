...
## Findings
- **[UX-1] HIGH**: The frontend `RunDetail.tsx` page displays evidence metadata but lacks an actual download link for the evidence artifact. The CLI is required to download/verify artifacts, which bypasses the frontend entirely.
